          ...
          <section className="py-24 bg-background overflow-hidden blueprint-grid opacity-80">
            <div className="container mx-auto px-4 md:px-6">
              <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
                ...
                <Link href="/akademik" className="group flex items-center gap-2 font-bold text-primary hover:gap-3 transition-all">
                  Semua Jurusan <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
          ...
          <section className="py-24 bg-background">
            <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-12 gap-16 items-start">
              ...
              <div className="md:col-span-7">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold mb-10 tracking-tight">Kunjungi Kampus & Ikuti Kegiatan Kami</h2>
                ...
                <Link href="/agenda" className="inline-block mt-8 font-bold text-primary hover:underline underline-offset-4">
              ...
              <div className="md:col-span-5 bg-primary rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/70 mb-8 leading-relaxed">
                    Penerimaan Mahasiswa Baru tahun akademik 2026/2027 telah dibuka. Dapatkan kesempatan beasiswa khusus untuk pendaftar gelombang pertama.
                  </p>
                  
                  <div className="flex flex-col gap-4 mb-10">
                    {admission.registration_steps?.map((step) => (
                      <div key={step.id} className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
